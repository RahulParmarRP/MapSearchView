package com.jarvis.mapsearchview.Geofence;
...
import com.jarvis.mapsearchview.MainActivity;
...
public class GeofenceTransitionService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geoFenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER || geoFenceTransition == Geofence.GEOFENCE_TRANSITION_EXIT) {
            ...
            String geofenceTransitionDetails = Utils.getGeofenceTransitionDetails(geoFenceTransition, triggeringGeofences);

            // Send notification details as a String
            //sendNotification( geofenceTransitionDetails );


            Utils.sendNotification(this, geofenceTransitionDetails);
/*new code
...
*/
    ...
    private Notification createNotification(String msg, PendingIntent notificationPendingIntent) {
        ...
        notificationBuilder
                ...
                .setColor(Color.RED)
                .setContentTitle(msg)
                .setContentText("Context Text Geofence Notification!")
